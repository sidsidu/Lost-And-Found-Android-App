...
import com.example.lostfound.databinding.ActivityReportFoundBinding
...
class ReportFoundActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityReportFoundBinding.inflate(layoutInflater)
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setItems(options) { _, which ->
                when (which) {
                    ...
                    1 -> imagePicker.launchGallery(galleryLauncher)
                }
            }
            .show()
    }
